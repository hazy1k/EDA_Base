...
#define CW_GPIO6 CW_GPIOA
#define CW_GPIO5 CW_GPIOA
#define CW_GPIO4 CW_GPIOA
#define CW_GPIO3 CW_GPIOA
#define CW_GPIO2 CW_GPIOA
#define CW_GPIO1 CW_GPIOA

#define CW_GPIO_PIN6 GPIO_PIN_5
#define CW_GPIO_PIN5 GPIO_PIN_4
#define CW_GPIO_PIN4 GPIO_PIN_3
#define CW_GPIO_PIN3 GPIO_PIN_2
#define CW_GPIO_PIN2 GPIO_PIN_1
#define CW_GPIO_PIN1 GPIO_PIN_0
...
void Seg_Init(void)
{
	...
	GPIO_InitStruct.Pins = GPIO_PIN_0 | GPIO_PIN_1 | GPIO_PIN_2|GPIO_PIN_3 | GPIO_PIN_4 | GPIO_PIN_5;  //a0 a1配置为模拟输入
...
void Close_ALL(void)
{
  GPIO_InitTypeDef GPIO_InitStruct; 
	...
	GPIO_InitStruct.Pins =  GPIO_PIN_0 | GPIO_PIN_1 | GPIO_PIN_2|GPIO_PIN_3 | GPIO_PIN_4 | GPIO_PIN_5;
	GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.IT = GPIO_IT_NONE; 
  GPIO_Init(CW_GPIOA, &GPIO_InitStruct);   
}
